...
import com.telesens.afanasiev.loader.DataLoader;
...
public class Main {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ...
        Thread tStationXmlWriter = new Thread(new XmlWriter("./src/main/resources/xml/logs/station.xml",
                BusNetwork.Stations.class, Stations.Log.class, new StationXmlWriter()));
...
//        DaoUtils.setPrivateField(routeTest, "ID", 1);
    ...
    private static void writeXmlButNetwork(BusNetwork busNetwork) {
        try  {
            ...
            marshaller.marshal(busNetwork, new FileWriter("./src/main/resources/xml/load/busnetwork.xml"));
    ...
    private static void writeXmlTimeTable(com.telesens.afanasiev.dao.impl.jaxb.schemes.RunTimetable xmlRunTimetable) {
        try  {
            ...
            Marshaller marshaller = jaxbContext.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
            marshaller.marshal(xmlRunTimetable, new FileWriter("./src/main/resources/xml/load/runtimetable.xml"));
    ...
    private static void writeXmlPassGenRules(PassGenRules passGenRules) {
        try {
            ...
            marshaller.marshal(passGenRules, new FileWriter("./src/main/resources/xml/load/passgeneration.xml"));
